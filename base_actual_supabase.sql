...
CREATE TABLE public.adjudicaciones_licitacion (
    ...
    id_interno integer DEFAULT nextval('adjudicaciones_licitacion_id_interno_seq'::regclass) NOT NULL,
...
CREATE TABLE public.ai_token_usage_logs (
    id integer DEFAULT nextval('ai_token_usage_logs_id_seq'::regclass) NOT NULL PRIMARY KEY,
...
CREATE TABLE public.archivos_cotizaciones (
    id uuid DEFAULT gen_random_uuid() NOT NULL PRIMARY KEY,
    id_interno integer DEFAULT nextval('archivos_cotizaciones_id_interno_seq'::regclass) NOT NULL,
...
CREATE TABLE public.archivos_ordenes_compra (
    id uuid DEFAULT gen_random_uuid() NOT NULL PRIMARY KEY,
    id_interno integer DEFAULT nextval('archivos_ordenes_compra_id_interno_seq'::regclass) NOT NULL,
    adjudicacion_id uuid REFERENCES public.adjudicaciones_licitacion(id),
    nombre_archivo text,
    url_archivo text,
    formato text,
...
CREATE TABLE public.auditoria_eventos (
    id uuid DEFAULT gen_random_uuid() NOT NULL PRIMARY KEY,
    id_interno integer DEFAULT nextval('auditoria_eventos_id_interno_seq'::regclass) NOT NULL,
...
CREATE TABLE public.candidatos_homologacion (
    id uuid DEFAULT gen_random_uuid() NOT NULL PRIMARY KEY,
    id_interno integer DEFAULT nextval('candidatos_homologacion_id_interno_seq'::regclass) NOT NULL,
...
CREATE TABLE public.finanzas_licitacion (
    id uuid DEFAULT gen_random_uuid() NOT NULL PRIMARY KEY,
    id_interno integer DEFAULT nextval('finanzas_licitacion_id_interno_seq'::regclass) NOT NULL,
    licitacion_id uuid REFERENCES public.licitaciones(id),
    tipo_documento text,
    descripcion text,
    monto NUMERIC,
...
CREATE TABLE public.homologaciones_productos (
    id uuid DEFAULT gen_random_uuid() NOT NULL PRIMARY KEY,
    id_interno integer DEFAULT nextval('homologaciones_productos_id_interno_seq'::regclass) NOT NULL,
    licitacion_id uuid REFERENCES public.licitaciones(id),
...
CREATE TABLE public.item_licitacion_especificaciones (
    id uuid DEFAULT gen_random_uuid() NOT NULL PRIMARY KEY,
    id_interno integer DEFAULT nextval('item_licitacion_especificaciones_id_interno_seq'::regclass) NOT NULL,
    item_id uuid REFERENCES public.items_licitacion(id),
    semantic_run_id uuid REFERENCES public.semantic_runs(id),
    especificacion text,
    tipo text,
...
CREATE TABLE public.items_licitacion (
    id uuid DEFAULT gen_random_uuid() NOT NULL PRIMARY KEY,
    id_interno integer DEFAULT nextval('items_licitacion_id_interno_seq'::regclass) NOT NULL,
    licitacion_id uuid REFERENCES public.licitaciones(id),
    descripcion text,
    cantidad NUMERIC,
    unidad text,
...
CREATE TABLE public.licitacion_archivos (
    id uuid DEFAULT gen_random_uuid() NOT NULL PRIMARY KEY,
    id_interno integer DEFAULT nextval('licitacion_archivos_id_interno_seq'::regclass) NOT NULL,
    licitacion_id uuid NOT NULL REFERENCES public.licitaciones(id),
...
CREATE TABLE public.licitaciones (
    id uuid DEFAULT gen_random_uuid() NOT NULL PRIMARY KEY,
    id_interno integer DEFAULT nextval('licitaciones_id_interno_seq'::regclass) NOT NULL,
...
CREATE TABLE public.tabla_contenidos (
    id integer DEFAULT nextval('tabla_contenidos_id_seq'::regclass) NOT NULL PRIMARY KEY,
    documento_id uuid REFERENCES public.licitacion_archivos(id),
    titulo text,
...
CREATE TABLE public.usuarios (
    id integer DEFAULT nextval('usuarios_id_seq'::regclass) NOT NULL PRIMARY KEY,
